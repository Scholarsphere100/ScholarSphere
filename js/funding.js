...
export function updateFundingSummary() {
    ...
    //debugging purposes
    console.log("🔍 Found Spent Element:", spentEl ? spentEl.textContent : "undefined");
    console.log("🔍 Found Remaining Element:", remainingEl ? remainingEl.textContent : "undefined");
